...
import static com.github.firmwehr.gentle.backend.ir.IkeaBøx.IkeaRegisterSize.BITS_32;
import static com.github.firmwehr.gentle.backend.ir.IkeaBøx.IkeaRegisterSize.BITS_64;
import static com.github.firmwehr.gentle.backend.ir.IkeaBøx.IkeaRegisterSize.BITS_8;
...
public enum X86Register {
	...
	private Map<IkeaBøx.IkeaRegisterSize, String> names;

	X86Register(Map<IkeaBøx.IkeaRegisterSize, String> names) {
		this.names = names;
	}
