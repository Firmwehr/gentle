...
public class CalleeSavedPrepare {
	...
	private static final Set<X86Register> CALLEE_SAVED = EnumSet.of(//
		X86Register.RBX, X86Register.RSP, X86Register.RBP, X86Register.R12, X86Register.R13, X86Register.R14,
		X86Register.R15);
